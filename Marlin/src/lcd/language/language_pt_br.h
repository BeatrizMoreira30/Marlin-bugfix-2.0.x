...
namespace Language_pt_br {
  ...
  LSTR MSG_QTDE_COPOS                     = _UxGT("Qtde de Copos");
  ...
  LSTR MSG_ADVANCED_SETTINGS              = _UxGT("Configurações");
  LSTR MSG_CONFIGURATION                  = _UxGT("Leitura Parcial");
  ...
  LSTR MSG_MOTION                         = _UxGT("Leitura Completa");
